...
def get_images(folder_name):
    ...
    image_urls = [f'http://100.75.76.102:5000/images/{folder_name}/{image}' for image in images]
...
def image_metadata():
    ...
    image_path = image_url.replace("http://100.75.76.102:5000/images", "C:/Users/Administrator/Documents/Image-Classification-pulltest/venv/venv/ClassifyResult")
...
# 사용자가 삭제하길 원하는 이미지의 링크를 받고 삭제 수행 후
...
def delete_image():
    ...
    try:
        ...
        image_files = [file for file in os.listdir(folder_path) if file.endswith(('jpg', 'jpeg', 'png', '.JPEG', '.JPG', '.PNG'))]
        image_count = len(image_files)
        folder_name = os.path.basename(folder_path)


        base_url = "http://100.75.76.102:5000/images"
...
def delete_images(): 
    try:
        ...
        for url in data:
            ...
            image_path = url.replace("http://100.75.76.102:5000/images", "C:/Users/Administrator/Documents/Image-Classification-pulltest/venv/venv/ClassifyResult")
            image_path = image_path.strip('"')
            image_path = os.path.normpath(image_path)
...
def delete_folder():
    data = request.json
    delete_folder_path = "C:/Users/Administrator/Documents/Image-Classification-pulltest/venv/venv/ClassifyResult/" + data
